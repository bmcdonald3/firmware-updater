...
// Generated: 2026-04-29T10:13:51-07:00
//
...
import (
	...
	_ "github.com/example/fms-mvp/pkg/apiversion"
	...
	"github.com/example/fms-mvp/internal/storage/ent/migrate"

	_ "github.com/mattn/go-sqlite3"

	. "github.com/example/fms-mvp/internal/middleware"
	"github.com/openchami/fabrica/pkg/events"

	"github.com/example/fms-mvp/pkg/reconcilers"
...
var rootCmd = &cobra.Command{
	Use:   "fms-mvp",
	Short: "",
	Long:  `fms-mvp - A Fabrica-generated OpenCHAMI service`,
	RunE:  runServer,
}

var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Start the fms-mvp server",
	Long:  `Start the fms-mvp HTTP server with the configured options`,
	RunE:  runServer,
}
...
func init() {
	...
	// Global flags
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.fms-mvp.yaml)")
...
func initConfig() {
	...
	if cfgFile != "" {
		...
		viper.SetConfigName(".fms-mvp")
	}

	// Environment variables
	viper.SetEnvPrefix("FMS-MVP")
	viper.AutomaticEnv()
...
func runServer(cmd *cobra.Command, args []string) error {
	...
	go func() {
		...
		log.Println("Starting background firmware HTTP server on :8090")
		if err := http.ListenAndServe(":8090", http.FileServer(firmwareDir)); err != nil {
			log.Println("Background firmware server failed", "error", err)
		}
	}()

	log.Printf("Starting fms-mvp server...")
	...
	if eventConfig.EventTypePrefix == "" {
		eventConfig.EventTypePrefix = "fms-mvp.resource"
	}
...
func healthHandler(w http.ResponseWriter, r *http.Request) {
	...
	w.Write([]byte(`{"status":"healthy","service":"fms-mvp"}`))
}
...
var versionCmd = &cobra.Command{
	...
	Long:  `Print the version number of fms-mvp`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("fms-mvp v1.0.0")
	},
}
