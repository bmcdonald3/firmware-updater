...
import (
	...
	_ "github.com/user/firmware-manager/pkg/apiversion"
	"github.com/openchami/fabrica/pkg/versioning"
	 ...
	 "github.com/user/firmware-manager/internal/storage/ent/migrate"
	...
	. "github.com/user/firmware-manager/internal/middleware"
	

	
	"github.com/openchami/fabrica/pkg/reconcile"
	"github.com/user/firmware-manager/pkg/reconcilers"
...
var rootCmd = &cobra.Command{
	Use:   "firmware-manager",
	Short: "",
	Long:  `firmware-manager - A Fabrica-generated OpenCHAMI service`,
	RunE:  runServer,
}

var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Start the firmware-manager server",
	Long:  `Start the firmware-manager HTTP server with the configured options`,
	RunE:  runServer,
}
...
func init() {
	...
	// Global flags
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.firmware-manager.yaml)")
...
func initConfig() {
	...
	if cfgFile != "" {
		...
		viper.SetConfigName(".firmware-manager")
	}

	// Environment variables
	viper.SetEnvPrefix("FIRMWARE-MANAGER")
	viper.AutomaticEnv()
...
func runServer(cmd *cobra.Command, args []string) error {
	log.Printf("Starting firmware-manager server...")
	...
	if eventConfig.EventTypePrefix == "" {
		eventConfig.EventTypePrefix = "firmware-manager.resource"
	}
	...
	// Register custom routes (firmware file server, etc.)
	if err := RegisterCustomRoutes(r); err != nil {
		log.Printf("Warning: failed to register custom routes: %v", err)
	}
...
func healthHandler(w http.ResponseWriter, r *http.Request) {
	...
	w.Write([]byte(`{"status":"healthy","service":"firmware-manager"}`))
}
...
var versionCmd = &cobra.Command{
	...
	Long:  `Print the version number of firmware-manager`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("firmware-manager v1.0.0")
	},
}
