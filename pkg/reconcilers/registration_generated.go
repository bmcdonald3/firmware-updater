...
func RegisterReconcilers(controller *reconcile.Controller, client reconcile.ClientInterface, eventBus events.EventBus) error {
	// Register FirmwareImage reconciler
	firmwareimagesReconciler := NewDefaultFirmwareImageReconciler(client, eventBus)
	if err := controller.RegisterReconciler(firmwareimagesReconciler); err != nil {
		return err
	}
